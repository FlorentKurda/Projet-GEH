...
define( 'PRODUCT_CATALOG_SYNC_VERSION', '0.4.0' );
...
require_once PRODUCT_CATALOG_SYNC_DIR . 'includes/class-catalog-admin-repository.php';
...
require_once PRODUCT_CATALOG_SYNC_DIR . 'includes/class-catalog-admin-page.php';
